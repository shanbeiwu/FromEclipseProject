...
public class ResponseReaderHttpServletResponseWrapper extends HttpServletResponseWrapper {
    ...
    public ServletOutputStream getOutputStream() throws IOException {
        return new ServletOutputStreamLog(bytes); // 将数据写到 byte 中
    }
	...
	class ServletOutputStreamLog extends ServletOutputStream {
        private ByteArrayOutputStream ostream ;

        public ServletOutputStreamLog(ByteArrayOutputStream ostream) {
